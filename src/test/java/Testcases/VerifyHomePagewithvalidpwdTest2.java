...
public class VerifyHomePagewithvalidpwdTest2 {
	...
	public void startup()
	{
        report=new ExtentReports(".\\Reports\\LoginTestReport4.html");
		
		Log=report.startTest("Test1", "Just to test");
		
		Log.log(LogStatus.INFO, "Test4 started");
	...
	{
	System.out.println("Hi i am other test4");
	}
