...
public class VerifyHomePagewithvalidpwdtest1 {
	...
	public void startup()
	{
        report=new ExtentReports(".\\Reports\\LoginTestReport3.html");
		
		Log=report.startTest("Test1", "Just to test");
		
		Log.log(LogStatus.INFO, "Test3 started");
	...
	{
	System.out.println("Hi i am other test3");
	}
